...
export default class AppScreen extends Component{
    ...
    getButtonsUsingForLoop1 = (num) => { 
        ...
        getButtonsUsingForLoop3 = () => { 
            const array = [] 
            const msg3 = [
                "1. Anglerfish have a large bioluminescent lure used to attract prey in the darkness.",
                "2. Phronima is a genus of small, deep sea hyperiid amphipods of the family Phronimidae. It is found throughout the world's oceans, except in polar regions.",
                "3. The Orange Roughy can live up to 200 years. Deep sea life often has elongated life spans.",
                "4. The Venus flytrap sea anemone is a large sea anemone that superficially resembles a Venus flytrap. It closes its tentacles to capture prey or to protect itself. ",
                "5. The common name, frilled shark, derives from the fringed appearance of the six pairs of gill slits at the shark's throat.",
                "6. The goblin shark is a rare species of deep-sea shark. Sometimes called a living fossil, it is the only extant representative of the family Mitsukurinidae, a lineage some 125 million years old. ",
                "7. Marine hatchetfishes or deep-sea hatchetfishes are small deep-sea mesopelagic ray-finned fish of the stomiiform subfamily Sternoptychinae.",
                "8.Dragonfish is also called sea moth.",
                "9. Marine biologists from MBARI nicknamed this startlingly large jellyfish which grows over one meter in diameter as big red.",
                "10. The yeti crab, an unusual, hairy crab with no eyes, was discovered in 2005 on a hydrothermal vent near Easter Island.",
                "11. The bluntnose sixgill shark often simply called the cow shark, is the largest hexanchoid shark, growing to 20 ft (6.1 m) in length.",
                "12. The narwhal is the unicorn of the sea, a pale-colored porpoise found in Arctic coastal waters and rivers",
                "13. Sea pens are colonial marine cnidarians belonging to the order Pennatulacea.",
                "14. The telescope octopus is a species of pelagic octopus found in tropical and subtropical regions of the Indian and Pacific Oceans. It is transparent, almost colorless, and has 8 arms, all of the same size.",
                "15. Colossal Squid are the largest known squid species. They can reach a length of 10 meters and weigh up to 700 kg.",
                "16. Vampire Squids eat marine snow - organic material that falls from shallower waters."
